...
__export(src_exports, {
  definePathHelper: () => definePathHelper,
  formatUrl: () => import_core.formatUrl,
  request: () => request
});
module.exports = __toCommonJS(src_exports);
var import_inertia = require("@inertiajs/inertia");
var import_core = require("@js-from-routes/core");
function definePathHelper(method, pathTemplate) {
  const helper = (options) => request(method, pathTemplate, options);
  helper.path = (options) => (0, import_core.formatUrl)(pathTemplate, options);
...
async function request(_method, url, options = {}) {
  ...
  url = (0, import_core.formatUrl)(url, params);
  ...
  return import_inertia.Inertia[method](url, ...args);
}
