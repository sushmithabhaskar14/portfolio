class PortfoliosController < ApplicationController
    ...
    respond_to do |format|
      if @portfolio.save
        ActiveRecord::Base.transaction do
          @portfolio.attachments.build(content:  params[:portfolio][:attachment], imageable_type:  'Portfolio', imageable_id: @portfolio.id ).save
  ...
  private
    ...
    def portfolio_params
      params.require(:portfolio).permit(:name, :email, :description, :attachment, :skillset, :url_info)
    end
end
