...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference("Campaign.count") do
      post campaigns_url, params: { campaign: { campaign_id: @campaign.campaign_id, campaign_name: @campaign.campaign_name } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { campaign_id: @campaign.campaign_id, campaign_name: @campaign.campaign_name } }
